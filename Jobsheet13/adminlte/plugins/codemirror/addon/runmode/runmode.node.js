...
require.cache[require.resolve("adminlte/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("adminlte/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("adminlte/lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["adminlte/lib/codemirror"], mod); }
